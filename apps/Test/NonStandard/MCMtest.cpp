...
int main(){
  ...
  const short N = 20, nMean=10000; //number of multipath and mean realization
  ...
  MCModel<N,float> u1(0.7071,fmax);
  MCModel<N+1,float> u2(0.7071,fmax);
  ...
  //Recalculate the teoretical ACF too, in some model(like this one) it varies.
